  ...
  const services = [
    {
      ...
      description:
        "Comprehensive hull, dock, and marine structure inspections with detailed reporting.",
      features: [
    ...
    },
    {
      ...
      description:
        "Professional underwater search and recovery operations for lost items and evidence.",
      features: [
    ...
    },
    {
      ...
      description:
        "Complete marine cleaning services to maintain your vessel's performance and appearance.",
      features: [
        "Hull cleaning",
        "Propeller polishing",
        "Zinc replacement",
